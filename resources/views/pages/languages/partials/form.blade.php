<div class="row g-4">
    <div class="col-md-6">
        <label class="form-label fw-semibold text-secondary small mb-1">Name <span class="text-danger">*</span></label>
        <input type="text"
            name="name"
    ...
    <!-- Code Field -->
    <div class="col-md-6">
        <label class="form-label fw-semibold text-secondary small mb-1">Code <span class="text-danger">*</span></label>
        <input type="text"
            name="code"
...
<div class="row g-4">
    ...
    <div class="col-md-6">
        <label class="form-label fw-semibold text-secondary small mb-1">Directory</label>
        <input type="text"
            name="directory"
...
<div class="row g-4">
    ...
    <div class="col-md-6">
        <label class="form-label fw-semibold text-secondary small mb-1">Default</label>
