            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3 mb-4 pb-3 border-bottom border-light">
                        <div>
                            <h4 class="card-title fw-bold text-dark m-0 mb-1 d-inline-block">Categories Management</h4>
                    ...
                    <div class="row align-items-center mb-4 justify-content-between g-3" id="categories-toolbar">
                    ...
                    <div class="table-responsive rounded-3 border border-light custom-table-wrapper">
                        <table id="categories-table" class="table align-middle table-hover mb-0 w-100">
...
<script>
    $(document).ready(function() {
        $('#categories-table').DataTable({
            ...
            language: {
                search: "",
                searchPlaceholder: "Quick lookup categories..."
            },
